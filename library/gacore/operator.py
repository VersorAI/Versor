"""
.. currentmodule:: gacore.operator

=============================================
operator functions (:mod:`gacore.operator`)
=============================================
...
It can be thought of as equivalent to the builtin :mod:`operator` module, but for the operators from geometric algebra.
    ...
    >>> import functools
    >>> import gacore.operator
    >>> from gacore.g3 import *
    >>> Ms = [e1, e1 + e2, e2 + e3]  # list of multivectors
    >>> assert functools.reduce(gacore.operator.op, Ms) == Ms[0] ^ Ms[1] ^ Ms[2]
...
.. versionchanged:: 1.3.0
    These functions used to be in :mod:`gacore`, but have been moved to this
    submodule.
