r"""
.. currentmodule:: gacore.numba

===============================================
numba extension support (:mod:`gacore.numba`)
===============================================

.. versionadded:: 1.4.0

This module provides :mod:`numba` extension types :class:`MultiVectorType` and
:class:`LayoutType` corresponding to :class:`~gacore.MultiVector` and
:class:`~gacore.Layout`.
...
as :func:`gacore.tools.g3c.fast_up`.
...
``gacore`` tries as hard as possible to reduce this second overhead, by
