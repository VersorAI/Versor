...
.. currentmodule:: gacore.tools.classify
...
from gacore._multivector import MultiVector
from gacore._conformal_layout import ConformalLayout
...
def classify(x) -> Blade:
    ...
    The multivector should be from a :class:`~gacore.ConformalLayout`, such
    as the one returned by :func:`gacore.conformalize`.
