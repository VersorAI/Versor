"""
.. currentmodule:: gacore.tools

========================================
tools (:mod:`gacore.tools`)
========================================
...
def omoh(A: Union[Frame, List[MultiVector]], B: Union[Frame, List[MultiVector]]) -> np.ndarray:
    r'''
    Determines homogenization scaling for two :class:`~gacore.Frame`\ s related by a Rotor

    This is used as part of the :func:`~gacore.tools.orthoFrames2Versor` algorithm,
    ...
    :meth:`~gacore.ConformalLayout.homo`, which is the method used to
    homogenize.

    Parameters
    --------------
    A : list of vectors, or gacore.Frame
        the set of vectors before the transform
    B : list of vectors, or gacore.Frame
...
def mat2Frame(A: np.ndarray,
    ...
    Returns
    -------
    a : list of gacore.MultiVector
        The resulting vectors
    layout : gacore.Layout
...
def frame2Mat(B, A=None, is_complex=None):
    ...
    # you need float() due to bug in gacore
...
def orthoFrames2Versor(B, A=None, delta: float = 1e-3,
    ...
    eps: float
        ...
        If `None`, use the `gacore.eps()` global eps.
    det : [+1,-1,None]
    ...
    remove_scaling : bool
        ...
        original space. See :func:`~gacore.tools.omoh` for more. See 4.6.2 of
        :cite:`fontijne-reconstructing`.

    Returns
    ---------
    R : gacore.MultiVector
        the Versor.
    rs : list of gacore.MultiVector
...
def rotor_decomp(V: MultiVector, x: MultiVector) -> Tuple[MultiVector, MultiVector]:
    ...
    Parameters
    ---------------
    V : gacore.MultiVector
        rotor
    x : gacore.MultiVector
        vector

    Returns
    -------
    H : gacore.MultiVector
        rotor which contains x
    U : gacore.MultiVector
