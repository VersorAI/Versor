...
from gacore import Cl
from gacore.tools import orthoFrames2Versor as of2v
from gacore._numba_utils import DISABLE_JIT
...
class TestG3Tools:
    ...
    def test_quaternion_conversions(self, rng):  # noqa: F811
        ...
        """
        from gacore.tools.g3 import rotor_to_quaternion, quaternion_to_rotor
        from gacore.tools.g3c import random_rotation_rotor
        for i in range(1000):
    ...
    def test_rotation_matrix_conversions(self, rng):   # noqa: F811
        ...
        """
        from gacore.g3c import down
        from gacore.tools.g3 import rotation_matrix_to_rotor, rotor_to_rotation_matrix
        from gacore.tools.g3c import random_rotation_rotor, random_conformal_point, apply_rotor
        for i in range(1000):
            rotor = random_rotation_rotor(rng=rng)
    ...
    def test_generate_rotation_rotor_and_angle(self, rng):  # noqa: F811
        ...
        """
        from gacore.tools.g3 import generate_rotation_rotor, random_unit_vector, angle_between_vectors
        for i in range(1000):
    ...
    def test_find_rotor_aligning_vectors(self, rng):  # noqa: F811
        ...
        """
        from gacore.g3c import layout
        e1 = layout.blades['e1']
        e2 = layout.blades['e2']
        from gacore.tools.g3 import random_euc_mv, random_rotation_rotor, rotor_align_vecs
...
class TestPointProcessing:
    def test_convex_hull_vertices(self, rng):  # noqa: F811
        from gacore.tools.g3c import random_conformal_point
        from gacore.tools.point_processing import GAConvexHull
    ...
    def test_GADelaunay_facets(self, rng):  # noqa: F811
        from gacore.g3c import up, blades, layout
        e1 = blades['e1']
        e2 = blades['e2']
        einf = layout.einf
        from gacore.tools.g3c import random_conformal_point, project_points_to_plane
        from gacore.tools.point_processing import GADelaunay
        point_list = [random_conformal_point(rng=rng) for i in range(100)]
