...
* Run `python -m pip show gacore` to determine which version you are using (or print `gacore.__version__` from python)
...
@software{python_clifford,
  author       = {Hugo Hadfield and
                  ...
                  Robert Kern and
                  {The Pygae Team}},
  title        = {gacore: High-Performance Geometric Algebra (formerly clifford)},
  publisher    = {Zenodo},
